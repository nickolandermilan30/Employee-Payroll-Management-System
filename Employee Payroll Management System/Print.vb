...
Public Class Print
    ...
    Private logoPath As String =
        Path.Combine(Application.StartupPath, "Image\Logo.png")
    ...
    ' CENTER TEXT
    ' =========================
    Private Sub DrawCentered(g As Graphics,
                             text As String,
                             font As Font,
                             brush As Brush,
    ...
    ' PRINT BUTTON
    ' =========================
    Private Sub btn_Print_Click(sender As Object,
                                e As EventArgs) Handles btn_Print.Click
    ...
    ' SAVE BUTTON
    ' =========================
    Private Sub btn_Save_Click(sender As Object,
                               e As EventArgs) Handles btn_Save.Click
    ...
    ' PREVIEW BUTTON
    ' =========================
    Private Sub Preview_Click(sender As Object,
                              e As EventArgs) Handles Preview.Click
