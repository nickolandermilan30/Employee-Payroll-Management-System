...
Partial Class ExtraHomepage
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ExtraHomepage))
        Panel1 = New Panel()
        Panel4 = New Panel()
        ...
        logoutbtn.BackColor = Color.FromArgb(CByte(208), CByte(39), CByte(82))
        logoutbtn.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        logoutbtn.ForeColor = Color.White
        logoutbtn.Image = CType(resources.GetObject("logoutbtn.Image"), Image)
        logoutbtn.ImageAlign = ContentAlignment.MiddleLeft
        logoutbtn.Location = New Point(-5, -4)
        logoutbtn.Name = "logoutbtn"
        logoutbtn.Padding = New Padding(25, 0, 35, 0)
        logoutbtn.Size = New Size(203, 64)
        ...
        logout.Location = New Point(-6, -59)
        logout.Name = "logout"
